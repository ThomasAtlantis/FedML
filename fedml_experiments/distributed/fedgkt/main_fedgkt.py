...
def init_training_device(process_ID, fl_worker_num, gpu, gpu_num_per_machine):
...
if __name__ == "__main__":
    ...
    device = init_training_device(process_id, worker_number - 1, args.gpu, args.gpu_num_per_server)
